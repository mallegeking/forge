...
export const en = {
  ...
  home: {
    ...
    // "Ember" redesign — Home screen
    liftsReady: "lifts ready to load",
    forgedToday: "Forged today",
    ...
    prShort: "PR",
    records: "Records",
    bodyweight7d: "Bodyweight · 7d",
    thisWeek: "this week",
    proteinTarget: "Daily protein target",
    proteinBasis: "based on",
    theWeek: "The week",
    weekDone: "done",
    done: "Done",
    todayTag: "Today",
  ...
  session: {
    ...
    loggedDash: "logged —",
    upNext: "Up next",
    exerciseComplete: "Exercise complete — skip to continue",
    sec30: "30 sec",
    restOver: "Rest over —",
    go: "Go",
    leaveConfirm:
  ...
  statistics: {
    ...
    streak: "Week streak",
    workouts4w: "Workouts · 4 wks",
    volume4w: "Volume · 4 wks",
    volume: "Volume over time",
    consistency: "Consistency",
    needsAttention: "Needs attention",
    stuckAt: "stuck at {w} kg × {n} sessions",
    deloadHint: "○ deload",
