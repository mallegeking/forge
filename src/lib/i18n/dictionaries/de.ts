...
export const de: Dictionary = {
  ...
  home: {
    ...
    postpone: "Diese Woche auslassen",
    exercises: "Übungen",
    exercise: "Übung",
    ...
    // "Ember"-Redesign — Startbildschirm
    liftsReady: "Übungen startklar",
    forgedToday: "Heute geschmiedet",
    coachNoteLabel: "Coach-Notiz",
    ask: "Fragen →",
    kgReady: "KG BEREIT",
    lastSession: "Letzte Einheit",
    volumeMoved: "Bewegtes Volumen",
    duration: "Dauer",
    minShort: "Min",
    prShort: "PR",
    records: "Rekorde",
    bodyweight7d: "Körpergewicht · 7T",
    thisWeek: "diese Woche",
    proteinTarget: "Tägliches Proteinziel",
    proteinBasis: "basierend auf",
    theWeek: "Die Woche",
    weekDone: "erledigt",
    done: "Fertig",
    todayTag: "Heute",
  ...
  program: {
    ...
    duplicateProgram: "Programm duplizieren",
    copySuffix: "Kopie",
  ...
  session: {
    ...
    rest: "Pause",
    skip: "Überspringen",
    // "Ember" fokussierter Einheiten-Flow
    exercise: "Übung",
    of: "von",
    logSet: "Satz erfassen",
    next: "Weiter",
    skipExercise: "Übung überspringen",
    skipToFinish: "Zum Ende springen",
    addNote: "Notiz",
    ...
    loggedDash: "erfasst —",
    upNext: "Als Nächstes",
    exerciseComplete: "Übung fertig — überspringen zum Fortfahren",
    sec30: "30 Sek",
  ...
  statistics: {
    ...
    workouts4w: "Einheiten · 4 Wo.",
    volume4w: "Volumen · 4 Wo.",
    volume: "Volumen über die Zeit",
    consistency: "Konsistenz",
    needsAttention: "Braucht Aufmerksamkeit",
    stuckAt: "hängt bei {w} kg × {n} Einheiten",
    deloadHint: "○ Deload",
